...
public class Jdbc_L6_update {
	...
	public static void main(String[] args) throws SQLException {
		...
		try {
			...
			// UPDATE the employee
			System.out.println("\nEXECUTING THE UPDATE FOR: Darshan Magare\n");
			
			int rowsAffected = myStmt.executeUpdate(
					"update employees " +
					"set email='darshan.m@gmail.com' " + 
					"where last_name='Magare' and first_name='Darshan'");
			System.out.println("Rows affected"+rowsAffected);
			// Call helper method to display the employee's information
			System.out.println("AFTER THE UPDATE...");
			displayEmployee(myConn, "Darshan", "Magare");
